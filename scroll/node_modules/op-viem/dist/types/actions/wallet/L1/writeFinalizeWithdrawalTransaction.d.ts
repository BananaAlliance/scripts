...
export declare const FUNCTION = "finalizeWithdrawalTransaction";
export type FinalizeWithdrawalTransactionParameters = Omit<MessagePassedEvent, 'withdrawalHash'>;
export type WriteFinalizeWithdrawalTransactionParameters<TChain extends Chain | undefined = Chain, TAccount extends Account | undefined = Account | undefined, TChainOverride extends Chain | undefined = Chain | undefined> = {
 ...
 */
export declare function writeFinalizeWithdrawalTranasction<TChain extends Chain | undefined, TAccount extends Account | undefined, TChainOverride extends Chain | undefined = undefined>(client: WalletClient<Transport, TChain, TAccount>, { withdrawal, optimismPortalAddress, ...rest }: WriteFinalizeWithdrawalTransactionParameters<TChain, TAccount, TChainOverride>): Promise<WriteContractReturnType>;
//# sourceMappingURL=writeFinalizeWithdrawalTransaction.d.ts.map