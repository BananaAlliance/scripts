...
declare const FUNCTION = "depositTransaction";
...
export type WriteDepositTransactionParameters<TChain extends Chain | undefined = Chain, TAccount extends Account | undefined = Account | undefined, TChainOverride extends Chain | undefined = Chain | undefined> = {
 ...
 */
export declare function writeDepositTransaction<TChain extends Chain | undefined, TAccount extends Account | undefined, TChainOverride extends Chain | undefined = undefined>(client: WalletClient<Transport, TChain, TAccount>, { args: { to, value, gasLimit, isCreation, data }, optimismPortalAddress, ...rest }: WriteDepositTransactionParameters<TChain, TAccount, TChainOverride>): Promise<WriteContractReturnType>;
export {};
//# sourceMappingURL=writeDepositTransaction.d.ts.map